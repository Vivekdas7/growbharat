    ...
    >
      ...
      >
        ...
        <div className="grid-cols-1 sm:col-span-2 flex justify-start sm:justify-start mt-2">
          <button
            type="submit"
            className="w-full sm:w-max flex items-center justify-center gap-2 bg-gray-900 text-white dark:bg-white dark:text-gray-900 text-sm font-semibold px-8 py-3.5 rounded-xl cursor-pointer hover:scale-102 active:scale-98 transition-all duration-200 shadow-md"
          >
            Send Message
            <img src={assets.arrow_icon} alt="" className="w-3.5 dark:invert sm:dark:invert-0" />
          </button>
        </div>
      </motion.form>
    </motion.div>
