  ...
  return (
    <>
      <motion.div
        ...
        className="flex justify-between items-center px-6 sm:px-12 lg:px-24 xl:px-40 py-4 sticky top-0 z-40 backdrop-blur-xl font-medium bg-white/70 dark:bg-gray-900/70 border-b border-gray-100 dark:border-gray-800/50"
      >
        {/* Logo */}
        <img
        ...
        <div className="flex items-center gap-3 sm:gap-4 relative z-50">
          ...
          >
            Contact <img src={assets.arrow_icon} className="w-3.5 invert dark:invert-0" alt="arrow" />
          </a>
